...
contract Foxcon2022 is ERC721, Ownable {
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
    ...
    string memory ticketType = "GA";

    if(vipTicketHolders[id]) {
      ticketType = "VIP";
    }
        ...
        Base64.encode(
          bytes(
            abi.encodePacked(
              ...
              // '"external_url":"https://github.com/metamask/nft-tickets-workshop/nft-ticket-data/', id.toString(), '.svg",', 
              '"attributes":[{"trait_type":"Ticket Type", "value":"', ticketType,  '"}],',
  ...
  function renderTokenTopById(uint256 id) internal view returns (string memory) {
    ...
    return string(abi.encodePacked(
      ...
      '<g id="dateText" transform="matrix(0.955615,0,0,0.891404,-0.890378,-58.3668)"><text x="24px" y="240px" style="font-family:''BalooDa2-Regular'';font-size:30px;fill:#FFF;">10 DEC / ',ticketType,'</text></g>',
