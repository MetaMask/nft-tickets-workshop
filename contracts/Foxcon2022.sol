        ...
        Base64.encode(
          bytes(
            abi.encodePacked(
              ...
              '"attributes": [{"ticket_type": "',ticketType ,'"}],',
  ...
  function renderTokenBottomById(uint256 id) internal view returns (string memory) {
    ...
    return string(abi.encodePacked(
      ...
      '<g id="stub2" transform="matrix(0.489601,0,0,0.489601,36.3616,34.5613)">',
        ...
        '</text>',
      '</g>',
      '<g id="stub3" transform="matrix(0.160667,0,0,0.160667,66.1511,212.911)"><text x="62px" y="410px" style="font-family:''BalooDa2-ExtraBold'';font-weight:800;font-size:108px;fill:#FF9200;">',ticketType ,'</text></g>'
    ));
  }
